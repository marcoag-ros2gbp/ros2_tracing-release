...
Name:           ros-rolling-lttngpy
Version:        8.0.0
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS lttngpy package

License:        Apache License 2.0
URL:            https://index.ros.org/p/lttngpy/
Source0:        %{name}-%{version}.tar.gz

Requires:       lttng-tools-devel
...
%changelog
* Tue Feb 20 2024 Christophe Bedard <christophe.bedard@apex.ai> - 8.0.0-2
